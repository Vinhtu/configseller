								...
								<div class="overview-item overview-item--c1">
									<div class="overview__inner">
										...
										<div class="overview-chart">
											...
											<canvas id="widgetChart1" height="83" width="142"
												class="chartjs-render-monitor"
												style="display: block; height: 67px; width: 114px;"></canvas>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="overview-item overview-item--c2">
									<div class="overview__inner">
										...
										<div class="overview-chart">
											...
											<canvas id="widgetChart2" height="143" width="142"
												class="chartjs-render-monitor"
												style="display: block; height: 115px; width: 114px;"></canvas>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="overview-item overview-item--c3">
									<div class="overview__inner">
										...
										<div class="overview-chart">
											...
											<canvas id="widgetChart3" height="143" width="142"
												class="chartjs-render-monitor"
												style="display: block; height: 115px; width: 114px;"></canvas>
										</div>
									</div>
								...
								<div class="overview-item overview-item--c4">
									<div class="overview__inner">
										...
										<div class="overview-chart">
											...
											<canvas id="widgetChart4" height="75" width="142"
												class="chartjs-render-monitor"
												style="display: block; height: 60px; width: 114px;"></canvas>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="au-card recent-report">
									<div class="au-card-inner">
										...
										<div class="recent-report__chart">
											...
											<canvas id="recent-rep-chart" height="166" width="302"
												class="chartjs-render-monitor"
												style="display: block; height: 133px; width: 242px;"></canvas>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="row no-gutters">
											...
											<div class="col-xl-6">
												<div class="percent-chart">
													...
													<canvas id="percent-chart" height="350" width="302"
														class="chartjs-render-monitor"
														style="display: block; height: 280px; width: 242px;"></canvas>
												</div>
											</div>
										</div>
									</div>
