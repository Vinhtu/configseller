...
<head>
    ...
    <link href="<c:url value="/assets/admin/vendor/mdi-font/css/material-design-iconic-font.min.css"/>" rel="stylesheet" media="all">
...
<body class="animsition">
    ...
    <script src="<c:url value="assets/admin/wow/wow.min.js"/>"></script>
